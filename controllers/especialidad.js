...
const save = async(req, res) => {
  ...
  try {
    const result = await prisma.especialidades.create({
      data: {
        tipo_especialidad,
...
const actualize = async (req, res) => {
  ...
  try {        
    const result = await prisma.especialidades.update({
        where: {
...
const getAll = async (req, res) => {
    ...
    try {        
        const result = await prisma.especialidades.findMany()
...
const getById = async (req, res) => {
    try {
        const result = await prisma.especialidades.findUnique({
            where: {
                id: Number(req.params.id)
            },
        });
