...
const save = async(req, res) => {
  ...
  try {
    const result = await prisma.resoluciones.create({
        select: campos_resolucion,
        data: {
          tipo,
          numero,
          ejercicio,
...
const actualize = async (req, res) => {
  ...
  try {        
    const result = await prisma.resoluciones.update({
        where: { 
...
const getAll = async (req, res) => {
    ...
    try {        
        const result = await prisma.resoluciones.findMany();
...
const getById = async (req, res) => {
    ...
    try {
        const result = await prisma.resoluciones.findUnique({
            where: {
                id: id
            },
        });
